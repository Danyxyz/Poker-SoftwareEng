	...
	public static void display(String title) {
		...
		label.setText("\t"+"\t"+"\t"+"NOTE: THIS IS A SIMPLER VERSION OF THE GAME, NOT EVERY RULE IS IMPLEMENTED"+
                  ...
                  "\t"+"Poker is a game of chance. However, when you introduce the concept of betting, poker gains quite a bit of skill and psychology."
                              + "(This isn't to say that there isn't skill at poker when nothing is at risk, there just isn't nearly as much). \n"
                              + "This is meant as a very basic primer into the rules of poker, for more information, get a book on the game (or start playing with a group of people who know how. "
                              + "/n It's more expensive than reading a book, but the group won't mind. *Snicker*).\r\n" +
                        ...
                        + " There are four suits (spades, hearts, diamonds and clubs); however, no suit is higher than another. All poker hands contain five cards, the highest hand wins.\r\n" +
                        ...
                        + "A straight flush is a straight (5 cards in order, such as 5-6-7-8-9) that are all of the same suit. As in a regular straight, you can have an ace either high (A-K-Q-J-T) or low (5-4-3-2-1). However, a straight may not 'wraparound'. (Such as K-A-2-3-4, which is not a straight).\n"
                        ...
                        "Four of a kind is simply four cards of the same rank. If there are two or more hands that qualify, the hand with the higher-rank four of a kind wins.\n"
                                   + " If, in some bizarre game with many wild cards, there are two four of a kinds with the same rank, then the one with the high card outside the four of the kind wins.\n"
                        ...
                        "\r"+"Full House\r\n" +
                        "A full house is a three of a kind and a pair, such as K-K-K-5-5. Ties are broken first by the three of a kind, then pair. So K-K-K-2-2 beats Q-Q-Q-A-A, which beats Q-Q-Q-J-J. \n(Obviously, the three of a kind can only be similiar if wild cards are used.)\r\n" +
                        "Flush\r\n" +
                        ...
                        "\r"+"Straight\r\n" +
                        "A straight is 5 cards in order, such as 4-5-6-7-8. An ace may either be high (A-K-Q-J-T) or low (5-4-3-2-1). However, a straight may not 'wraparound'.\n"
                        + "(Such as Q-K-A-2-3, which is not a straight). When straights tie, the highest straight wins. (AKQJT beats KQJT9 down to 5432A). If two straights have the same value (AKQJT vs AKQJT) they split the pot.\r\n" +
                        "\r"+"Three of a Kind\r\n" +
                        ...
                        "High Card\r\n" +
                        "This is any hand which doesn't qualify as any one of the above hands. If nobody has a pair or better, then the highest card wins. If multiple people tie for the highest card, they look at the second highest, then the third highest etc. \n"
                        + "High card is also used to break ties when the high hands both have the same type of hand (pair, flush, straight, etc).\r\n" +
                        "Betting\r\n" +
                        "So, how do you bet? Poker is, after all, a gambling game. In most games, you must 'ante' something (amount varies by game, our games are typically a nickel), just to get dealt cards. After that players bet into the pot in the middle. \n"
                        + " At the end of the hand, the highest hand (that hasn't folded) wins the pot. Basically, when betting gets around to you (betting is typically done in clockwise order), you have one of three choices:\r\n" +
                        "Call\r\n" +
                        ...
                        + "Continuing the above example, if you had bet a dime, the other person raised you fifteen cents (up to a quarter), you might raise a quarter (up to fifty cents). Since you owed the pot 15 cents for calling and 25 for your raise, you would put 40 cents into the pot.\r\n" +
                        "Fold\r\n" +
                        ...
                        + "Then each player may discard up to 3 cards (4 if your last card is an ace or wild card, in some circles) and get back (from the deck) as many cards as he/she discarded. \n"
                        + "Then there is another round of betting, and then hands are revealed (the showdown) and the highest hand wins the pot. So you are the dealer at a five card draw game (against four other players, Alex, Brad, Charley and Dennis (seated in that order to your left). \n"
                        ...
                        + "(You deal replacements to everyone) and now it's your turn. You have a pair of kings, three spades, and no chance for a straight. It's best to just keep the two kings and hope to get a 3rd or fourth king. You discard three cards, and your new hand is: Ks-Kd-Kc-4c-8h. Three Kings! \n"
                        + "A nice little hand.\r\n" +
                        "What do you suppose the others were trying for? Well, Brad kept two cards, so he probably had a pair (just like you) but it probably wasn't aces, so even if brad got a three of a kind, you probably beat him. Charley kept four cards, so he was probably trying for a straight or flush. \n"
                        + "(If Charley had four of a kind, he might have bet much harder). The big problem is Dennis. He raised earlier, and only drew two cards. He might be bluffing, but he could have had three of a kind off the deal... In any case, the second round of betting starts (with dealers left).\r\n" +
                        "\r\n" +
                        "Brad bets a nickel.\r\n" +
		...
		ScrollPane box = new ScrollPane(label);
